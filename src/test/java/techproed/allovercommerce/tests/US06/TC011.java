...
public class TC011 extends PreConditionLogged {

    @Test(description = "TC011 - Kullanıcı Sepete (Cart) eklediği ürünleri görebilmeli.")
    public void testProductVisibleInTheCart() {
